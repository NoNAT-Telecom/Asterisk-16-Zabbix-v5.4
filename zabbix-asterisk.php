<?php
/*
Script criado para facilitar a comunicaÁ„o entre ZABBIX e ASTERISK, utilizando AMI (Asterisk Manager Interface).
Este script monitora:
                ...
                "longestcall       - Retorna o valor em minutos da chamada com mais tempo em duraÁ„o";
...
function peerstatus($peer,$search) {
	...
	while ($line != "Event: SIPpeerstatusComplete") {
		...
		if($line=="PeerStatus: Unknown"){
			echo "0\n";
			fclose($socket);
			exit(0);
		}

		if($line=="PeerStatus: Unmonitored"){
			echo "0\n";
			fclose($socket);
			exit(0);
		}
...
switch($argv[1]){
	...
	case '-h':
		echo "Help\n\n";
                ...
                echo "activecalls       - Retorna quantas chamadas est√£o em curso\n";
                echo "asteriskrunning   - Retorna 1 se asterisk estiver rodando. Se n√£o 0\n";
                echo "longestcall       - Retorna o valor em minutos da chamada com mais tempo em dura√ß√£o\n";
                echo "onlinepeers       - Retorna a quantidade de SIP online\n";
                echo "\n";
                echo "Modo de execu√ß√£o:\n";
	...
	Default:
		echo "Comando ".$argv[1]." n√£o encontrado. Digite -h ou ? para saber mais\n\n";
		break;
}
